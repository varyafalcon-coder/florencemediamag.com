...
layout: place
title: Il Santino
answer: A small stone room off Via di Santo Spirito, pouring wine from tiny producers
  with a serious showing of natural bottles, alongside crostoni, cheese and cured
  meat.
area: Santo Spirito
...
address: Via di Santo Spirito 60r
go_for: Wine from growers nobody else in the centre stocks, in a room the size of
  a cellar, with something warm to eat alongside it.
skip_if: You are a group. There is space for very few people and no way around it.
facts:
- label: Size
  value: Tiny, a converted cellar
- label: Wine
  value: Small producers, with a good natural selection
- label: Related to
  value: Il Santo Bevitore, a few doors along
consensus_source: Read across public reviews on Google, TripAdvisor and Yelp plus
  Italian wine writing in September 2026.
consensus:
- weight: Most
  level: high
  text: 'The room is the appeal: exposed stone, low ceiling, a handful of stools,
...
- label: Best time
  value: Before eight, or you will not sit.
- label: At weekends
  value: The room between the two places runs as a cocktail bar.
- label: Private events
  value: That room can be reserved for dinners.
- label: Nearby
